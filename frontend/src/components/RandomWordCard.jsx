      ...
      {loading ? (
        <div className="relative flex text-center flex-col  bg-light-50 shadow-lg bg-clip-border rounded-lg w-72 animate-pulse">
          <div className="px-8 pt-8 pb-4">
            ...
            <div className="block w-32 mx-auto py-2 h-2 mt-4 mb-2 font-sans text-base antialiased font-light leading-relaxed bg-primary-600/50  rounded-lg text-inherit">
              &nbsp;
            </div>
            <div className="block w-24 mx-auto  py-2 h-2 mb-2 font-sans text-base antialiased font-light leading-relaxed bg-dark-300/50  rounded-lg text-inherit">
              &nbsp;
            </div>
          </div>
          <div className="pb-8 mx-auto ">
            <div className="align-middle select-none font-sans font-bold text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-5 px-16 rounded-lg text-light shadow-gray-900/10 hover:shadow-gray-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none h-8 w-20 bg-primary-600/50 shadow-none hover:shadow-none">
              &nbsp;
            </div>
          </div>
        </div>
