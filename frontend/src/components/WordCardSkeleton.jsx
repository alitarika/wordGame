  ...
  return (
    <div className="relative">
      <button className="absolute rounded-full size-5 text-primary-700 top-5 left-5  hover:size-7 hover:top-4 hover:left-4">
        <MdDeleteForever className="blur-[2px] opacity-80 animate-pulse mx-auto text-xl hover:text-3xl" />
      </button>
      <Link title="Modify Word">
        <MdChangeCircle className="blur-[2px] opacity-80 animate-pulse absolute size-5 hover:size-7 hover:right-4 hover:top-4 text-dark bg-light rounded-full top-5 right-5" />
      </Link>
